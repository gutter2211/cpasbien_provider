...
def correctName(check_name, movie):
    ...
    for movietitle in MovieTitles:
        ...
        try:
            check_names.append(max(check_name.split('['), key=len))
        except:
            pass
        ...
        for check_name in list(set(check_names)):
            ...
            try:
                ...
                if len(check_words) > 0 \
                        ...
                        and len(list(set(movie_words) - set(check_words))) == 0:
                    result += 1
                    return result
            except:
                pass
...
def getReleaseNameYear(release_name, file_name=None):
    ...
    if release_name:
        ...
        try:
            ...
            log.debug('Could not detect via guessit "%s": %s', (file_name, release_name))
